			...
			<div class="row pb-10">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							...
							<div class="widget-icon">
								<div class="icon" data-color="#f6b220"><i class="fas fa-users"></i></div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_staff = mysqli_query($conn,"select * from tblemployees where role = 'HOD' ")or die(mysqli_error());
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">HOD's</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#f6b220"><span class="fas fa-user"></span></div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_hod = mysqli_query($conn,"select * from tblemployees where role = 'Dean' ")or die(mysqli_error());
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Deans</div>
							</div>
							<div class="widget-icon">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							...
							<div class="widget-icon">
								<div class="icon" data-color="#ff5b5b"><i class="fas fa-user-shield"></i></div>
							</div>
						</div>
					</div>
				</div>
