 ...
 if(isset($_POST['add']))
{
	...
	$deptshortname=$_POST['Communityshortname'];
     ...
     if ($count > 0){ 
        ...
        $query = mysqli_query($conn,"insert into community (CommunityName, CommunityShortName)
							...
							<div class="card-box pd-30 pt-10 height-100-p">
								...
								<section>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>Community Short Name</label>
												<input name="Communityshortname" type="text" class="form-control" required="true" autocomplete="off" style="text-transform:uppercase">
											</div>
										</div>
									</div>
